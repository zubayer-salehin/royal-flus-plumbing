...
const MakeAdmin = () => {
    ...
    useEffect(() => {
        setLoading(true);
        fetch("https://stroyka-server-side-production.up.railway.app/allUser", {
            method: "GET",
            headers: {
    ...
    const handleUserDelete = (id, uid) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://stroyka-server-side-production.up.railway.app/user?id=${id}&&uid=${uid}`, {
                    method: 'DELETE',
                    headers: {
    ...
    const handleUserAdmin = (email) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://stroyka-server-side-production.up.railway.app/user/admin/${email}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        "authorization": `Bearer ${localStorage.getItem("accessToken")}`
